...
//        FileHelpers.copyFile("resources/config/allure/categories.json", "target/allure-results/categories.json");
//        FileHelpers.copyFile("resources/config/allure/executor.json", "target/allure-results/executor.json");
...
//        ExtentReportManager.addDevices();
            ...
            ExtentReportManager.addException(iTestResult.getName(), e);
            e.printStackTrace();
        }
