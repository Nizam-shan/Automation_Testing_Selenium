...
public final class FrameworkConstants {
    ...
    public static final String SMTP_SERVER = PropertiesHelpers.getValue("SMTP_SERVER");
    public static final String SMTP_PORT = PropertiesHelpers.getValue("SMTP_PORT");
    public static final String SMTP_FROM = PropertiesHelpers.getValue("SMTP_FROM");
    public static final String SMTP_PASSWORD = PropertiesHelpers.getValue("SMTP_PASSWORD");
    public static final String SMTP_TO = PropertiesHelpers.getValue("SMTP_TO");
    ...
    public static final String EXPORT_VIDEO_PATH = PropertiesHelpers.getValue("EXPORT_VIDEO_PATH") != null ? PropertiesHelpers.getValue("EXPORT_VIDEO_PATH") : "exports/ExportData/Videos";
    ;
    ...
    // Unify
    public static final String EXCEL_UNIFY_LOGIN = PropertiesHelpers.getValue("EXCEL_UNIFY_LOGIN");
    public static final String URL_UNIFY = PropertiesHelpers.getValue("URL_UNIFY");
